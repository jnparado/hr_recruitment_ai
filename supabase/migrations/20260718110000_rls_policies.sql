-- RLS policies (duplicate of supabase/policies.sql for supabase db push)
...
create policy "interviews_authenticated_insert"
  on public.interviews for insert to authenticated with check (true);
...
create policy "interviews_authenticated_delete"
  on public.interviews for delete to authenticated using (true);
...
create policy "voice_interviews_authenticated_read"
  on public.voice_interviews for select to authenticated using (true);
...
create policy "voice_interviews_authenticated_insert"
  on public.voice_interviews for insert to authenticated with check (true);
...
create policy "voice_interviews_authenticated_update"
  on public.voice_interviews for update to authenticated
  using (true) with check (true);
...
create policy "voice_interviews_authenticated_delete"
  on public.voice_interviews for delete to authenticated using (true);
